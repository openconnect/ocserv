...
extern tOptProc
    ...
    optionPagedUsage,   optionResetOpt,     optionStackArg,
    optionTimeDate,     optionTimeVal,      optionUnstackArg,
    optionVendorOption, print_version;
static tOptProc
    doOptConfig, doOptDebug, doOptPid_File, doUsageOpt;
#define VER_PROC        print_version
...
static tOptDesc optDesc[OPTION_CT] = {
  ...
  {  /* entry idx, value */ 3, VALUE_OPT_TEST_CONFIG,
     /* equiv idx, value */ 3, VALUE_OPT_TEST_CONFIG,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
     /* opt state flags  */ TEST_CONFIG_FLAGS, 0,
     /* last opt argumnt */ { NULL }, /* --test-config */
     /* arg list/cookie  */ NULL,
     /* must/cannot opts */ NULL, NULL,
     /* option proc      */ NULL,
     /* desc, NAME, name */ TEST_CONFIG_DESC, TEST_CONFIG_NAME, TEST_CONFIG_name,
     /* disablement strs */ NULL, NULL },

  {  /* entry idx, value */ 4, VALUE_OPT_PID_FILE,
     /* equiv idx, value */ 4, VALUE_OPT_PID_FILE,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
...
2, along with this program.  If not, see <http://www.gnu.org/licenses/>.\n"));
  ...
  /* referenced via ocservOptions.pOptDesc->pzText */
  puts(_("Test the provided configuration file"));

  /* referenced via ocservOptions.pOptDesc->pzText */
  puts(_("Specify pid file for the server"));
  ...
  puts(_("ocserv - OpenConnect VPN server\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n"));
