 ...
 *
 *  It has been AutoGen-ed  August  3, 2013 at 10:51:57 AM by AutoGen 5.17.3
 ...
 */
static char const ocserv_opt_strs[1819] =
/*     0 */ "ocserv 0.1.5\n"
            "Copyright (C) 2013 Nikos Mavrogiannopoulos, all rights reserved.\n"
            "This is free software. It is licensed for use, modification and\n"
            "redistribution under the terms of the GNU General Public License,\n"
...
/*  1731 */ "ocserv 0.1.5\0"
/*  1744 */ "Usage: ocserv [options] -c [config]\n"
...
#define zFullVersion    (ocserv_opt_strs+1731)
...
#define ocserv_short_usage (ocserv_opt_strs+1744)
...
openconnect VPN client.  It follows the AnyConnect VPN protocol which is\n\
used by several CISCO routers.\n\n"));
  puts(_("This server supports multiple authentication methods, including PAM and\n\
certificate authentication.  Authenticated users are assigned an\n\
unprivileged worker process and obtain a networking (tun) device and an IP\n\
from a configurable pool of addresses.\n"));
